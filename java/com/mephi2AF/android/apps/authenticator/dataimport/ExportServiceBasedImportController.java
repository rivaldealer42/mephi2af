...
import com.mephi2AF.android.apps.authenticator.dataexport.IExportServiceV2;
...
public class ExportServiceBasedImportController implements com.mephi2AF.android.apps.authenticator.dataimport.ImportController {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
      try {
        ...
        if (importedData != null) {
          new com.mephi2AF.android.apps.authenticator.dataimport.Importer().importFromBundle(
              importedData,
