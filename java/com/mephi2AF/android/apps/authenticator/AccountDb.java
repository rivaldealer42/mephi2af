...
public class AccountDb {
  ...
  private String getAccountDbOpenFailedErrorString(Context context) {
    ...
    for (String directory : dirsToStat) {
      try {
        com.mephi2AF.android.apps.authenticator.FileUtilities.StatStruct stat = com.mephi2AF.android.apps.authenticator.FileUtilities.getStat(directory);
  ...
  private static byte[] decodeKey(String secret) throws DecodingException {
    return com.mephi2AF.android.apps.authenticator.Base32String.decode(secret);
  }
